  ...
  return (
    <div>
      <Head>
        ...
        />
        <link
          href="https://fonts.googleapis.com/css2?family=Poppins:ital,wght@0,300;0,400;0,700;1,200&display=swap"
          rel="stylesheet"
        />
        {/* viewport */}
        <meta charset="utf-8" />
        ...
        <meta
          name="keywords"
          content="Merra Marie, Fotografia, Video, Artista Argentina, Freelance"
        />
        {/* icon */}
        ...
        <meta
          ...
          content={ogType !== "website" ? 871 : 200}
        />
        <meta
          property="og:image:height"
          content={ogType !== "website" ? 564 : 200}
        />
      </Head>
...
export async function getStaticProps() {
  ...
  for (let i = 0; i < labels.length; i++) {
    ...
    const promise = axios.get(
      `${process.env.NEXT_PUBLIC_APIHOST}/public/${label}`
    );
